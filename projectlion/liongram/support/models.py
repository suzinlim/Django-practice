...
class Faq(models.Model):
    ...
    created_at = models.DateField(verbose_name="생성 일시", auto_now_add=True)
    updated_at = models.DateField(verbose_name="최종 수정 일시", auto_now=True)
...
class Inquiry(models.Model):
    ...
    status = models.CharField(verbose_name='질문 상태', max_length=5, choices=STATUS_CHOICES)
    category = models.CharField(verbose_name='카테고리', max_length=2, choices=CATEGORY_CHOICES)
    title = models.CharField(verbose_name='질문 내용', max_length=80)
